...
TASK_GROUPS = {
    ...
    "friction": [
        ("walk_friction_02x", 0.2),
        ("walk_friction_04x", 0.4),
        ("walk_friction_05x", 0.5),
        ("walk_friction_06x", 0.6),
        ("walk_friction_08x", 0.8),
        ("walk_friction_10x", 1.0),
        ("walk_friction_12x", 1.2),
        ("walk_friction_15x", 1.5),
        ("walk_friction_20x", 2.0),
    ],
    "actuator": [
        ("walk_actuator_04x", 0.4),
        ("walk_actuator_05x", 0.5),
        ("walk_actuator_06x", 0.6),
        ("walk_actuator_07x", 0.7),
        ("walk_actuator_08x", 0.8),
        ("walk_actuator_09x", 0.9),
        ("walk_actuator_10x", 1.0),
        ("walk_actuator_11x", 1.1),
        ("walk_actuator_12x", 1.2),
        ("walk_actuator_13x", 1.3),
        ("walk_actuator_14x", 1.4),
    ],
    "damping": [
        ("walk_damping_025x", 0.25),
        ("walk_damping_05x", 0.5),
        ("walk_damping_075x", 0.75),
        ("walk_damping_10x", 1.0),
        ("walk_damping_15x", 1.5),
        ("walk_damping_20x", 2.0),
        ("walk_damping_30x", 3.0),
    ],
    "gravity": [
        ("walk_gravity_06x", 0.6),
        ("walk_gravity_08x", 0.8),
        ("walk_gravity_10x", 1.0),
        ("walk_gravity_12x", 1.2),
        ("walk_gravity_14x", 1.4),
    ],
}
