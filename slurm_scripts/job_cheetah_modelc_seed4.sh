...
# 実験コマンド: Cheetah Model C (Proposed Method), Seed 4
python tdmpc2/train.py task=cheetah-run_randomized use_model_c=true seed=4 steps=1000000 \
